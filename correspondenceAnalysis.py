# -*- coding: utf-8 -*-
"""
Created on Thu Aug 26 15:28:55 2021
...
def _test():
    ...
    # df = pd.read_excel('C://Users//vincentkuo//Documents//test4CA.xlsx')
    # df = df.set_index('brand')
    df = pd.read_excel('C://Users//vincentkuo//Documents//test4CA_5(office).xlsx')
    df = pd.read_excel('C://Users//vincentkuo//Documents//test4CA_6(office_Late).xlsx')
    df = df.set_index('等級')
