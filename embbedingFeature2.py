# -*- coding: utf-8 -*-
"""
Created on Wed Nov 10 17:05:35 2021
...
df_train = pd.read_csv('C://Users//vincentkuo//Downloads//input//train.csv')
df_test = pd.read_csv('C://Users//vincentkuo//Downloads//input//test.csv')
...
def build_embedding_network():
    ...
    plot_model(model, show_shapes=True, to_file='embeddings_input.png')
...
df_sub = pd.DataFrame({'id' : df_test.id, 
                       'target' : y_pred_final},
                       columns = ['id','target'])
df_sub.to_csv('C://Users//vincentkuo//Downloads//input//NN_EntityEmbed_10fold-sub.csv', index=False)

pd.DataFrame(full_val_preds).to_csv('C://Users//vincentkuo//Downloads//input//NN_EntityEmbed_10fold-val_preds.csv',index=False)